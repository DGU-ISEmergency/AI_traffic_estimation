...
def check_area(midpoint_x, midpoint_y, area_pointA, area_pointD, array_ids, id, label):
    ...
    if (midpoint_x < area_pointA[0] and midpoint_x > area_pointD[0]) and (
            midpoint_y > area_pointA[1] and midpoint_y < area_pointD[1]):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                if len(tracked_dets) > 0:
                    ...
                    draw_boxes(im0, bbox_xyxy, identities, categories, names, array_ids_1=array_ids_1,array_ids_2= array_ids_2, array_ids_3=array_ids_3, array_ids_4=array_ids_4, array_ids_5=array_ids_5, array_ids_6= array_ids_6, array_ids_7=array_ids_7, array_ids_8=array_ids_8)
            ...
            cv2.line(im0, area2_pointA, area2_pointB, (255, 165, 0), 2)
            cv2.line(im0, area2_pointC, area2_pointD, (255, 165, 0), 2)

            cv2.line(im0, area3_pointA, area3_pointB, (255, 255, 0), 2)
            cv2.line(im0, area3_pointC, area3_pointD, (255, 255, 0), 2)

            cv2.line(im0, area4_pointA, area4_pointB, (0, 255, 0), 2)
            cv2.line(im0, area4_pointC, area4_pointD, (0, 255, 0), 2)

            # cv2.line(im0, area5_pointA, area5_pointB, (255, 255, 0), 2)
            # cv2.line(im0, area5_pointC, area5_pointD, (255, 255, 0), 2)

            cv2.line(im0, area6_pointA, area6_pointB, (0, 0, 255), 2)
            cv2.line(im0, area6_pointC, area6_pointD, (0, 0, 255), 2)

            cv2.line(im0, area7_pointA, area7_pointB,  (75, 0, 130), 2)
            cv2.line(im0, area7_pointC, area7_pointD,  (75, 0, 130), 2)

            cv2.line(im0, area8_pointA, area8_pointB, (238, 130, 238), 2)
            cv2.line(im0, area8_pointC, area8_pointD, (238, 130, 238), 2)
            ...
            print(array_ids_6, array_ids_7, array_ids_8)
            # print(counting_1, counting_4, counting_5, counting_7, counting_8)
